...
\hypersetup{breaklinks=true,
            ...
            pdfauthor={James P. Hamski (City University of New York)},
             pdfkeywords = {oil price, commodities, time series analysis, variance clustering},
...
\vskip 8.5pt \noindent \emph{Keywords}: oil price, commodities, time series analysis, variance clustering \par
...
\noindent  \section{Some section}\label{some-section}

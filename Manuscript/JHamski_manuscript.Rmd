...
A DCC model was constructed from an ARMA(1,1) and Glosten-Jagannathan-Runkle GARCH model. This means that we specified a.  
```{r, eval = T, fig.cap="Dynamic Conditional Correlation between Price and Returns"}
...
The method of using DCC models to investigate the relationship between oil price and volatility requires further exploration and theory development.
